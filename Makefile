...
# Define boost path
BOOST_PATH ?= "C:/Program Files/boost_1_79_0/boost"

# Define workspace
# WORKSPACE          ?= D:/Code/Projects/[CPP]Raylib_test_1
...
INCLUDE_PATHS = -I. -I$(RAYLIB_PATH)/src -I$(RAYLIB_PATH)/src/external -I"C:/Program Files/boost_1_79_0"
...
LDFLAGS = -L. -L"C:\raylib\w64devkit\x86_64-w64-mingw32\lib" 
...
$(PROJECT_NAME): $(OBJS)
	$(CC) -o $(PROJECT_NAME)$(EXT) $(OBJS) $(CFLAGS) $(INCLUDE_PATHS) $(LDFLAGS) -lbcrypt $(LDLIBS) -D$(PLATFORM)
